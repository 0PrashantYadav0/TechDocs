...
```mermaid
flowchart LR
    Grow["Know the ladder<br/>(what growth means)"] --> Lead["Lead without authority<br/>(influence)"]
    Lead --> Fork{"Fork in the road"}
    Fork -->|"deepen technical"| Staff["Staff/Principal (IC)"]
    Fork -->|"grow people"| EM["Engineering Manager"]
    Grow --> Wisdom["Career-long wisdom"]
    style Grow fill:#e7f3ff,stroke:#004085
    style Fork fill:#fff3e0,stroke:#e65100
    style Wisdom fill:#d4edda,stroke:#28a745
```
